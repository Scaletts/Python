...
Solution:
    1.
    Input devices: Mouse,Keyboard,Scanner,Microphone,Wedcam,....
    ...
    Definition: A program that converts a program written in one language to an equivalent program in another language.
    ....
"""